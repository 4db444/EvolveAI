    ...
    <aside class="w-64 glass border-r border-white/10 hidden md:flex flex-col sticky top-0 h-screen">
        ...
        <nav class="flex-1 px-4 space-y-2 mt-4">
            ...
            <a href="#" class="flex items-center space-x-3 p-3 rounded-lg text-gray-400 sidebar-link transition">
                ...
                <span>Mes Robots</span>
            </a>
            <div class="pt-10 pb-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Compte</div>
            <a href="#" class="flex items-center space-x-3 p-3 rounded-lg text-gray-400 sidebar-link transition">
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="glass p-6 rounded-3xl glass-hover flex flex-col">
                    ...
                    <button class="w-full py-3 bg-white text-black rounded-2xl font-bold hover:bg-purple-500 hover:text-white transition-all">
